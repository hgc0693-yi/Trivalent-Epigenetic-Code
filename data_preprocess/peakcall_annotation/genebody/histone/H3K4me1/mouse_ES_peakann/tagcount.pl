...
open(homer_FILE,'peak_annotation_result_genebody_sorted.txt') or die "$!";   ### sorted by "Gene Name"
open(output_FILE,'> H3K4me1_mouse_ES_tagcount_only_genebody.txt') or die "$!";
...
## print output_FILE "Gene_name fibro_only_genebody\n";  # print first row
