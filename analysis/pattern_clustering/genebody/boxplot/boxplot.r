...
boxplot(FC1,FC2,FC3,FC4,FC5,FC6,FC7,FC8,FC9,FC10,FC11,FC12,FC13,FC14,FC15,FC16,FC17,FC18,FC19, main="hESC vs fibroblast at gene body", ylab="log2 (FC) of Gene Expression per gene", names=c("Cluster1","Cluster2","Cluster3","Cluster4","Cluster5","Cluster6","Cluster7","Cluster8","Cluster9","Cluster10","Cluster11","Cluster12","Cluster13","Cluster14","Cluster15","Cluster16","Cluster17","Cluster18","Cluster19"), las=2, col="green", cex.axis=1.0, cex.main=0.9, outline=F)  
