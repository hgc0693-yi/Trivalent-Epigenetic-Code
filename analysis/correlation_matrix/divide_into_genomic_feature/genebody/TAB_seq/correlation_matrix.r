...
data <- read.table("hmC_MeDIP_TAB_Seq_H3K4me1_H4K8ac.txt", header=TRUE, sep="", row.names="Gene_name")
...
cor_data <- matrix(0, nrow=4, ncol=4)      ### make matrix-object
cor_data
...
rownames(cor_data) <- c("5hmC_hMeDIP", "5hmC_TAB-seq", "H3K4me1", "H4K8ac")
colnames(cor_data) <- c("5hmC_hMeDIP", "5hmC_TAB-seq", "H3K4me1", "H4K8ac")
head(cor_data, n=20)
dim(cor_data) 
class(cor_data)
mode(cor_data)
