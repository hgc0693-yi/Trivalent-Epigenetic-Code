...
corrplot(cor_data, type="upper", method="circle", shade.col=NA, tl.col="black", tl.srt=45,
         col = color(200), addCoef.col="black", addcolorlabel="no", order="hclust", number.cex = 0.7, diag = FALSE, cl.lim = c(-0.2, 1))
